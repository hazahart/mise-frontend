...
import {Home, Grid2X2, Star, Sparkles, MessageSquare, Calendar, ChefHat, PenSquare, X} from 'lucide-react';
...
export default function Sidebar({open, onClose}: SidebarProps) {
    ...
    return (
        <>
            <aside className="hidden md:flex fixed left-0 top-16 bottom-0 w-60
            ...
            <AnimatePresence>
                {open && (
                    <div className="md:hidden fixed inset-0 z-40 flex">
                        ...
                        >
                            <div
                                className="flex items-center justify-between px-4 py-4 border-b border-stone-200 dark:border-stone-800">
                                <span
                                    className="font-serif text-xl font-bold text-amber-700 dark:text-amber-400">Mise</span>
