...
export default function Navbar({onMenuClick, menuOpen}: NavbarProps) {
    ...
    return (
      ...
      flex items-center px-4 md:px-6 gap-3 z-50">
                    ...
                    <div className="ml-auto flex items-center gap-3">
                        ...
                        {firebaseUser ? (
                            <>
                                {usuario?.rol === 'premium' && (
                                    <span
                                        className="hidden sm:block text-xs font-semibold px-3 py-1 rounded-full bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-400">
        ⭐ Premium
      </span>
                                )}
                                <div
                                    className="w-9 h-9 rounded-full bg-stone-900 dark:bg-stone-100 flex items-center justify-center text-amber-200 dark:text-stone-900 font-semibold text-sm flex-shrink-0">
