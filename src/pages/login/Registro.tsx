        ...
        <div className="min-h-screen flex">
            ...
            <div className="flex-1 md:flex-none md:w-[480px] bg-stone-50 dark:bg-stone-900 flex items-center justify-center px-8 py-16">
                <div className="w-full max-w-sm bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700 rounded-2xl px-9 py-10">
                    <p className="text-xs font-medium tracking-widest uppercase text-amber-600 dark:text-amber-400 mb-3">Crea tu cuenta</p>
                    <h2 className="font-serif text-3xl font-bold text-stone-900 dark:text-stone-50 mb-1">Registrarse</h2>
                    <p className="text-stone-400 dark:text-stone-500 text-sm mb-8">Es gratis, siempre</p>

                    <button
                        onClick={handleGoogle}
                        disabled={loadingGoogle}
                        className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-sm font-medium border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900 text-stone-700 dark:text-stone-300 hover:bg-stone-50 dark:hover:bg-stone-800 transition-colors disabled:opacity-50 mb-5"
                    >
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        <div>
                            <label className="block text-xs font-medium uppercase tracking-widest text-stone-400 dark:text-stone-500 mb-2">Correo electrónico</label>
                            <input
                                type="email"
                                value={email}
                        ...
                        <div>
                            <label className="block text-xs font-medium uppercase tracking-widest text-stone-400 dark:text-stone-500 mb-2">Contraseña</label>
                            <input
                                type="password"
                                value={password}
                        ...
                        <div>
                            <label className="block text-xs font-medium uppercase tracking-widest text-stone-400 dark:text-stone-500 mb-2">Confirmar contraseña</label>
                            <input
                                type="password"
                                value={confirmar}
                    ...
                    <p className="text-center text-xs text-stone-400 dark:text-stone-500 mt-7">
                        ¿Ya tienes cuenta?{' '}
                        <Link to="/login" className="text-amber-600 dark:text-amber-400 font-medium hover:underline">Inicia sesión</Link>
                    </p>
                </div>
            </div>
        </div>
